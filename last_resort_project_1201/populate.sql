...
INSERT INTO room_fixture (fixtureId, name) VALUES (1, 'OLED TV'), (2, 'Crystal Bar'), (3, 'Marble Bath'), (4, 'Terrace'), (5, 'Workstation'), (6, 'Ocean View'), (7, 'Projector Screen');


-- ==========================================
-- 新增：fixture 分配规则（以后所有改动只改这里！！！）
-- ==========================================
INSERT INTO fixture_by_function (functionCode, fixtureId) VALUES
('SLP', 1), ('SLP', 3),           -- 普通房：OLED TV + Marble Bath
('STE', 1), ('STE', 2), ('STE', 3), ('STE', 4), ('STE', 5), ('STE', 6),  -- Suite 全配
('MTG', 1), ('MTG', 5), ('MTG', 7);           -- 会议室：OLED TV + Workstation


-- ==========================================
-- 自动给所有房间分配房型 functionCode（极度智能，根据你的定价规律）
-- ==========================================
INSERT INTO room_has_function (roomId, functionCode)
SELECT
roomId,
CASE
WHEN roomId >= 2000 THEN 'MTG'                    -- 会议室
WHEN baseRate >= 750 THEN 'STE'                   -- 高价房 = Grand Suite（可调整阈值）
ELSE 'SLP'                                        -- 其余为标准客房
END AS functionCode
FROM room;
...
-- ==========================================
-- 一条 SQL 批量分配所有 fixture（继承式）
-- ==========================================
INSERT INTO room_has_fixture (roomId, fixtureId)
SELECT
r.roomId,
fb.fixtureId
FROM room r
JOIN room_has_function rhf ON r.roomId = rhf.roomId
JOIN fixture_by_function fb ON rhf.functionCode = fb.functionCode;
-- （如果你以后想给某些房间额外加 fixture，直接再加一条针对性的 INSERT 就行）


-- 2. room (60+)
-- East Wing (Floors 1-5)
INSERT INTO room (roomId, floorId, roomNumber, baseRate, currentStatus, isSmokingRoom) VALUES
(101, 1, 'E101', 350, 'Clean', 1), (102, 1, 'E102', 350, 'Occupied', 1), (103, 1, 'E103', 350, 'Clean', 1), (104, 1, 'E104', 380, 'Dirty', 1), (105, 1, 'E105', 380, 'Clean', 1), (106, 1, 'E106', 400, 'Clean', 1),
(201, 2, 'E201', 350, 'Occupied', 0), (202, 2, 'E202', 350, 'Clean', 0), (203, 2, 'E203', 350, 'Clean', 0), (204, 2, 'E204', 380, 'Occupied', 0), (205, 2, 'E205', 380, 'Clean', 0), (206, 2, 'E206', 400, 'Occupied', 0),
(301, 3, 'E301', 450, 'Clean', 0), (302, 3, 'E302', 450, 'Clean', 0), (303, 3, 'E303', 450, 'Dirty', 0), (304, 3, 'E304', 480, 'Clean', 0), (305, 3, 'E305', 480, 'Clean', 0), (306, 3, 'E306', 500, 'Clean', 0),
(401, 4, 'E401', 550, 'Clean', 0), (402, 4, 'E402', 550, 'Occupied', 0), (403, 4, 'E403', 550, 'Clean', 0), (404, 4, 'E404', 580, 'Clean', 0), (405, 4, 'E405', 580, 'Clean', 0), (406, 4, 'E-406', 600, 'Clean', 0),
(501, 5, 'E501', 800, 'Clean', 0), (502, 5, 'E502', 800, 'Occupied', 0), (503, 5, 'E503', 800, 'Dirty', 0), (504, 5, 'E504', 850, 'Clean', 0), (505, 5, 'E505', 850, 'Occupied', 0), (506, 5, 'E506', 1000, 'Clean', 0);

-- West Wing (Floors 1-5)
INSERT INTO room (roomId, floorId, roomNumber, baseRate, currentStatus, isSmokingRoom) VALUES
(601, 6, 'W101', 350, 'Clean', 1), (602, 6, 'W102', 350, 'Clean', 1), (603, 6, 'W103', 350, 'Occupied', 1), (604, 6, 'W104', 350, 'Clean', 1), (605, 6, 'W105', 380, 'Dirty', 1), (606, 6, 'W106', 400, 'Clean', 1),
(701, 7, 'W201', 350, 'Clean', 0), (702, 7, 'W202', 350, 'Clean', 0), (703, 7, 'W203', 350, 'Clean', 0), (704, 7, 'W204', 380, 'Occupied', 0), (705, 7, 'W205', 380, 'Clean', 0), (706, 7, 'W206', 400, 'Occupied', 0),
(801, 8, 'W301', 450, 'Occupied', 0), (802, 8, 'W302', 450, 'Clean', 0), (803, 8, 'W303', 450, 'Clean', 0), (804, 8, 'W304', 480, 'Clean', 0), (805, 8, 'W305', 480, 'Clean', 0), (806, 8, 'W306', 500, 'Clean', 0),
(901, 9, 'W401', 550, 'Clean', 0), (902, 9, 'W402', 550, 'Clean', 0), (903, 9, 'W403', 550, 'Occupied', 0), (904, 9, 'W404', 580, 'Clean', 0), (905, 9, 'W405', 580, 'Clean', 0), (906, 9, 'W406', 600, 'Clean', 0),
(1001, 10, 'W501', 1200, 'Clean', 0), (1002, 10, 'W502', 1200, 'Occupied', 0), (1003, 10, 'W503', 1200, 'Clean', 0), (1004, 10, 'W504', 1500, 'Dirty', 0), (1005, 10, 'W505', 1500, 'Clean', 0), (1006, 10, 'W506', 2000, 'Clean', 0);

-- Meeting Rooms
INSERT INTO room (roomId, floorId, roomNumber, baseRate, currentStatus, isSmokingRoom) VALUES
(2001, 1, 'Conf A', 2500, 'Clean', 0), (2002, 1, 'Conf B', 2500, 'In Use', 0), (2003, 1, 'Grand Ball', 8000, 'Clean', 0);

-- Config
INSERT INTO room_has_function (roomId, functionCode) SELECT roomId, 'SLP' FROM room WHERE baseRate < 800;
INSERT INTO room_has_function (roomId, functionCode) SELECT roomId, 'STE' FROM room WHERE baseRate >= 800 AND baseRate < 2500;
...
-- Adjacency
-- 连通房：清空后批量添加（假设每层相邻房间连通）
DELETE FROM room_adjacency;

-- 批量生成：同层相邻房间 (roomId 连续的)
INSERT INTO room_adjacency (roomId1, roomId2, connectionType)
SELECT 
    r1.roomId, r2.roomId, 'Adjacent'
FROM room r1
JOIN room r2 ON r1.floorId = r2.floorId AND r1.roomId + 1 = r2.roomId;

-- Beds
-- 先清空（开发阶段用）
DELETE FROM room_has_bed;

-- 批量分配：根据房型（functionCode）或 baseRate 设置
INSERT INTO room_has_bed (roomId, bedTypeId, count)
SELECT 
    r.roomId,
    CASE 
        WHEN rhf.functionCode = 'STE' THEN 4  -- Suite 用 California King
        WHEN rhf.functionCode = 'MTG' THEN 0  -- 会议室无床
        ELSE 1  -- 标准房用 King
    END AS bedTypeId,
    CASE 
        WHEN rhf.functionCode = 'STE' THEN 2  -- Suite 有 2 张大床
        ELSE 1
    END AS count
FROM room r
JOIN room_has_function rhf ON r.roomId = rhf.roomId
WHERE rhf.functionCode != 'MTG';  -- 跳过会议室
